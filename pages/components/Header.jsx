...
export default function Header() {
  ...
  return <>
    <header className="bg-white sticky top-0 z-40 w-full px-2 md:px-4">
      ...
      >
        <Link className="flex gap-1 items-center text-text font-medium text-lg hover:text-secondary " href="/">
        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          <nav aria-label="Global" className="hidden md:block">
            <ul className="flex items-center gap-6 text-md">
              <li>
                <Link className={`text-black transition hover:text-secondary/75 ${pathname === '/' ? 'text-primary' : ""} `} href="/">
                  Home
                </Link>
              </li>

              <li>
                <Link className={`text-black transition hover:text-secondary/75 ${pathname === ('/products') ? 'text-primary' : ""} `} href="/products">
                  All Products
                </Link>
              </li>
            </ul>
              ...
              <div className="md:hidden absolute top-24 right-0 bg-white border border-zinc-200 rounded shadow-lg p-6 text-lg ">
                <nav aria-label="Global">
                  <ul className="flex flex-col items-start gap-6 text-md">
                    <li>
                      <Link className={`text-accent transition hover:text-accent ${pathname === '/' ? active : inActive} `} href="/"
                        onClick={toggleMobileNav}
                      >
                        Home
                      </Link>
                    ...
                    <li>
                      <Link className={`text-accent transition hover:text-accent ${pathname === '/products' ? active : inActive}`} href="/products"
                        onClick={toggleMobileNav}
                      >
                        All Products
                      </Link>
                    ...
                    <li>
                      <Link className={`text-accent transition hover:text-accent ${pathname === '/categories' ? active : inActive}`} href="/categories"
                        onClick={toggleMobileNav}
                      >
                        Categories
                      </Link>
