...
export default function Cart() {
  ...
  async function stripeCheckout() {
    const response = await axios.post('/api/checkout', {
      email: session.user.email, name: session.user.name, address, country, pincode, city, cartProducts
    });
                  ...
                  <div className="mt-8 flex justify-end border-t border-gray-100 pt-8">
                    <div className=" max-w-md space-y-4">
                      <dl className="space-y-0.5 text-md text-gray-700">
                        <div className="flex justify-end text-red-600 border-b mb-3">
                      ...
                      <div className="flex justify-end">
                        <Link
                          class="group flex items-center justify-between gap-4 rounded-lg border border-current px-4 py-2 text-black-600 transition-colors hover:bg-green-600 focus:outline-none focus:ring active:bg-black-500"
                          href="/products"
                        >
              ...
              <div class="space-y-5">
                <div class="grid grid-cols-12 gap-5">
                  ...
                  <div class="col-span-2">
                    <label class="mb-1 block text-sm font-medium text-text">Pincode</label>
                    <input type="text" name="zip" class="block w-full rounded-md p-3 border border-gray-300 shadow-sm focus:border-primary-400 focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500" placeholder="Pincode"
                      value={pincode}
                  ...
                  <div class="col-span-12 text-center w-full">
                    <button
                      ...
                      className="disabled block rounded bg-secondary px-5 py-3 text-md text-text transition hover:bg-black-300 w-full"
                    >
                      Checkout
                    </button>
                  </div>
    ...
    <div className="grid h-screen px-4 bg-white place-content-center">
      <div className="text-center">
        ...
        <button
          ...
          className="inline-block px-5 py-3 mt-6 text-sm font-medium text-text bg-secondary rounded hover:bg-secondary focus:outline-none focus:ring"
        >
          Login / Register
        </button>
      </div>
